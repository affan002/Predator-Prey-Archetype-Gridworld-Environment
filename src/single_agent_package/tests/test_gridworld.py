from single_agent_package.gridworld import GridWorldEnv
from single_agent_package.helpers.helper import print_mdp_tuple

# Create an environment (e.g., CartPole)
env = GridWorldEnv(render_mode="human", size=10, perc_num_obstacle=10)
